...
public class EsSearchController {
    ...
    public List<Map<String,Object>> mutil_queryHit(@RequestParam String keyword, @RequestParam String indices, @RequestParam String fields){
        String[] fieldNames = {};
        if(fields.contains(",")) fieldNames = fields.split(",");
        else fieldNames[0] = fields;
        ...
        return esSearchService.mutilQueryHit(keyword,indexNames,fieldNames);
    }
